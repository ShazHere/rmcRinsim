...
public class GlobalParameters {
	...
	public static final int EXPLORATION_EVAPORATION_RATE = 5; //means  no. of ticks
	public static final int EXPLORATION_RATE = 50; //means no. of ticks
	public static final int TOTAL_TRUCKS = 5; //almost 29 trucks are there in the instances
	...
	public static final int MINUTES_TO_DELAY_ST = 60; //means ST should be delayed with MINUTES_TO_DELAY_ST if MINUTES_TO_CHANGE_ST4ORDER time has been elapsed 
	...
	public static final DateTime START_DATETIME = new DateTime(2011, 1, 10, 10, 00, 0 ,0, GregorianChronology.getInstance()); //07AM on 10Jan, 2011
