 ...
 * 
 */
public class RmcDelivery extends Parcel {  //parcel has to be given start location at the time of creation.
	...
	public RmcDelivery(RmcOrderAgent pOrder, Delivery pDelivery, int pDeliveryNo, Point pStation, Point pOrderDestination, int pLoadingDuration, int pUnloadingDuration,
			double pVolume) {
		super(pStation, pLoadingDuration, TimeWindow.ALWAYS, pUnloadingDuration, TimeWindow.ALWAYS, pVolume);
