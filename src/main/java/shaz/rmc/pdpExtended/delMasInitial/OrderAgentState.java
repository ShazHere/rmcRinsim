...
//		}*/
	...
	protected boolean isFeasibilityIntervalPassed(DateTime currTime) {
		...
		return currTime.minusSeconds(GlobalParameters.FEASIBILITY_INTERVAL_SEC).compareTo(orderAgent.getTimeForLastFeaAnt()) >= 0;
	}
...
/**
	...
	protected boolean makeOrderPlanAdjustment(OrderAgentPlan orderPlan, long startTime) {
		...
		logger.info(orderAgent.getOrder().getId() + "O Delivery Failure  handled (DelMAS) DeliveryNO = " + d.getDeliveryNo());
