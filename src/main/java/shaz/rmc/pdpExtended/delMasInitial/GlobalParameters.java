...
public final class GlobalParameters {
	...
	//GlobalParameters thisGlobalParameters;
	...
	} //Just to make sure its objects are never initiated
	...
	public static final int FEASIBILITY_INTERVAL_SEC = 70; //earlier 8 means send feeasibilty ants to near by after every X minutes.
	public static final int FEASIBILITY_EVAPORATION_INTERVAL_SEC = FEASIBILITY_INTERVAL_SEC + (30); //earlier + 5
	public static final int EXPLORATION_INTERVAL_SEC = 50; //means no. of mintues //earlier 2
	public static final int INTENTION_INTERVAL_SEC = 70; //means no. of mintues earlier = 5
	public static final int INTENTION_EVAPORATION_SEC = INTENTION_INTERVAL_SEC + (30); //earlier 3
	public static final int EXPLORATION_ANT_SEARCH_FOR_SEC_AFTER = INTENTION_EVAPORATION_SEC * 8; //EXP ants donot start searching for truckSchedule for currTime,
	//rather they search for currTime+this interval, coz sometimes after finding delivery, still travelUnit is also required
	//then its necessary that it is after currTime
	...
	public static final long AVAILABLE_SLOT_SIZE_HOURS = 1; //used to find slots that is available, after which exp ants checks them
